...
import { copyStrategyToClipboard, generateShareUrl, parseShareUrl, exportPDF, exportSlides, channelColors, channelTextColors, clampPriority, downloadJSON, downloadCSV } from "@/lib/utils"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button onClick={() => result && exportSlides(result, form, swot || undefined, branding)} className="flex items-center gap-2 px-3 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition text-sm font-medium text-gray-700 dark:text-gray-300 min-h-[44px]"><BarChart3 size={14} /> Slides</button>
